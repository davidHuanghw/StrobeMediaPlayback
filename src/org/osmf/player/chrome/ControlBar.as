...
package org.osmf.player.chrome
{
	...
	import org.osmf.player.chrome.widgets.LogoButton;
	...
	public class ControlBar extends AutoHideWidget implements IControlBar
	{
		...
		override public function configure(xml:XML, assetManager:AssetsManager):void
		{
			...
			logoButton.layoutMetadata.verticalAlign = VerticalAlign.MIDDLE;
			logoButton.layoutMetadata.horizontalAlign = HorizontalAlign.LEFT;
			rightControls.addChildWidget(logoButton);
			
			// Spacer
			var afterLogoSpacer:Widget = new Widget();
			afterLogoSpacer.width = 11;
			rightControls.addChildWidget(afterLogoSpacer);
			...
			configureWidgets
				(	[ leftMargin, beforePlaySpacer, pauseButton, playButton, previousButton, nextButton, afterPlaySpacer
					...
					, fullscreenEnterButton, fullscreenLeaveButton, afterFullscreenSpacer,logoButton
		...
		private var logoButton:LogoButton = new LogoButton();
