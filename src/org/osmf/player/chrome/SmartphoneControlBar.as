...
package org.osmf.player.chrome{
	...
	public class SmartphoneControlBar extends AutoHideWidget implements IControlBar{
		...
		override public function configure(xml:XML, assetManager:AssetsManager):void{
			...
			logoButton.layoutMetadata.verticalAlign = VerticalAlign.TOP;
			logoButton.layoutMetadata.horizontalAlign = HorizontalAlign.RIGHT;
			controlsBottom.addChildWidget(logoButton);
			
			// separator
			var afterLogoSeparator:Widget = getSeparator();
			controlsBottom.addChildWidget(afterLogoSeparator);
